...
2. **Identity Over Metadata (Aesthetic over Age):** Ignore "Russian Chanson", "Pop", or **Release Year** metadata. A 2024 track can be `Pop: Retro` and a 2005 track can be `Pop: Modern`. Use **Track Title**, **Artist**, and **Album** to research the true production vibe.
3. **Folk Priority:** Any Slavic/Caucasian folk elements (lyrics, instruments, motifs) **MUST** go to `Folk`. 
    - **CRITICAL: Execution > Tradition.** The *performance* and *energy* determine the sub-category (e.g., a lively/rhythmic traditional song is `Folk: Dance`).
